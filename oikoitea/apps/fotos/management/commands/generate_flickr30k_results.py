...
#        parser.add_argument('poll_id', nargs='+', type=int)
    ...
    def handle(self, *args, **options):
        ...
        for p in profundidades:
            ...
            # Recorremos cada una de las consultas, consultando su similaridad con los datos de la BD, 
            # y guardamos los resultados de cada prueba en una cola de prioridad
            for query in arr_query:
                ...
                # Contamos los aciertos de la app
                aciertos = 0
                iteraciones = 0
                for elem in nlargest(p, h):
                    sim, (descripcion, foto) = elem
                    if foto.nombre_archivo == query_foto.nombre_archivo:
                        aciertos += 1
                    iteraciones += 1

                sum_aciertos += aciertos
            ...
            print "Precision: ", 100.0 * sum_aciertos / len(arr_query)
            print ""
